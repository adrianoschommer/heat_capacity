...
raw_data = DataParse().add_average_surface_temp(raw_data,3,3)
raw_data = DataParse().filter_temperature_channels(raw_data, 151, 1)
...
AVG_Q_GEN = DataParse().calculate_AVG_Q_GEN(final_section_data, OCV)
